...
def process_coins():
    ...
    total = 0
    total += int(input("How many 1円 : "))
    total += int(input("How many 10円 : ")) * 10
    total += int(input("How many 50円 : ")) * 50
    total += int(input("How many 100円 : ")) * 100
    total += int(input("How many 500円 : ")) * 500
    return total
